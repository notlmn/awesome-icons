...
- [Flaticon](https://flaticon.com) - The largest database of free vector icons. ([Website](https://flaticon.com))
- [Fluent System Icons](https://github.com/microsoft/fluentui-system-icons#fluent-system-icons) - A collection of familiar, friendly and modern icons from Microsoft. ([Website](https://github.com/microsoft/fluentui-system-icons#fluent-system-icons))
...
- [ICONSVG](https://iconsvg.xyz) - Quick customizable SVG icons, easily customize strokes, ends, and joins of paths. ([Website](https://iconsvg.xyz))
...
- [Shape.so](https://shape.so) - Customizable, animated icons & illustrations exportable to code. ([Website](https://shape.so))
- [Super Tiny Icons](https://github.com/edent/SuperTinyIcons#readme) - Miniscule SVG versions of your favourite website and app logos, under 1KB each. ([Website](https://github.com/edent/SuperTinyIcons#readme))
...
- [Browser Logos](https://github.com/alrra/browser-logos#readme) - High resolution web browser logos. ([Website](https://github.com/alrra/browser-logos#readme))
- [Cryptocoins](https://github.com/AllienWorks/cryptocoins#readme) - Complete vector/webfont icon pack of your favourite cryptocurrencies. ([Website](https://github.com/AllienWorks/cryptocoins#readme))
...
- [Flag Kit](https://github.com/madebybowtie/FlagKit#readme) - Beautiful flag icons for usage in apps and on the web. ([Website](https://github.com/madebybowtie/FlagKit#readme))
- [Mapsicon](https://github.com/djaiss/mapsicon#readme) - A free collection of maps for every country in the world. ([Website](https://github.com/djaiss/mapsicon#readme))
...
- [Heroicons](https://www.heroicons.com) - Unique set of icons for your marketing website. ([Website](https://www.heroicons.com))
- [Iconic](https://useiconic.com) - The definitive icon set designed for the modern web. ([Website](https://useiconic.com))
- [Nucelo Icons](https://nucleoapp.com/premium-icons) - A premium library of SVG icons for iOS, Android & web projects. ([Website](https://nucleoapp.com/premium-icons))
