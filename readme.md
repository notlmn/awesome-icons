...
- [Iconify Deign](https://iconify.design) - Most popular icon sets in one framework containg over 200,000 open source vector icons. ([Website](https://iconify.design))
- [React Icons](https://react-icons.github.io/react-icons/) - Popular icon sets created especially for React projects. ([Website](https://react-icons.github.io/react-icons/))
